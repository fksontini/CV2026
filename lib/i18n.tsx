...
const fr: Dict = {
  ...
  "hero.rank": "GRADE : INGÉNIEUR SÉNIOR — SPÉCIALISTE M365 / POWER PLATFORM",
  "hero.rank.short": "INGÉNIEUR SÉNIOR",
  "hero.rank.code": "OF-4 // SENIOR ENGINEER",
  "hero.rank.years": "10+ ANS DE SERVICE",
  ...
  "id.field.unit": "UNITÉ",
  "id.field.base": "BASE",
  "id.value.grade": "INGÉNIEUR SÉNIOR",
...
const en: Dict = {
  ...
  "hero.rank": "RANK: SENIOR ENGINEER — M365 / POWER PLATFORM SPECIALIST",
  "hero.rank.short": "SENIOR ENGINEER",
  "hero.rank.code": "OF-4 // SENIOR ENGINEER",
  "hero.rank.years": "10+ YEARS OF SERVICE",
  ...
  "id.field.unit": "UNIT",
  "id.field.base": "BASE",
  "id.value.grade": "SENIOR ENGINEER",
  "id.value.unit": "DIGITAL WORKPLACE",
  "id.value.base": "ISSY-LES-MOULINEAUX, FR",
